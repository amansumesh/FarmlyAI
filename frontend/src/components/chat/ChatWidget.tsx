...
export const ChatWidget: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-24 right-4 z-50 flex flex-col items-end md:bottom-8">
      {/* Chat Window */}
      {isOpen && (
        <div className="mb-4 w-[90vw] max-w-[350px] bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden flex flex-col h-[500px] max-h-[70vh]">
          {/* Header */}
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
              ...
              <div 
                ...
                className={cn(
                  ...
                  msg.role === 'user' 
                    ...
                    : "bg-white border border-gray-200 text-gray-800 self-start mr-auto rounded-tl-none shadow-sm"
                )}
              >
                {msg.text}
              </div>
            ...
            {isLoading && (
              <div className="bg-white border border-gray-200 p-3 rounded-lg rounded-tl-none self-start mr-auto shadow-sm max-w-[85%]">
